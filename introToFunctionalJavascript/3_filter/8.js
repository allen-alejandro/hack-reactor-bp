...
// Write a function that returns a new array of spells that can be used by the 'Paladin' class:

var paladinSpells = function (spells) {
  return spells.filter(spell => spell.classes[0].name)
};


console.log(paladinSpells(spells));


console.log(spells[1].classes[0].name);