...
// Write a function that returns a new array of spells that have "M" as one of their components:

var componentMSpells = function (spells) {
  return spells.filter(spell => spell.components.includes('M'))
};


console.log(componentMSpells(spells));
