...
// Write a function that returns a new array of spells that can be cast instantaneously:

var instantSpells = function (spells) {
  return spells.filter(spell => spell.duration === 'Instantaneous')
};


console.log(instantSpells(spells));